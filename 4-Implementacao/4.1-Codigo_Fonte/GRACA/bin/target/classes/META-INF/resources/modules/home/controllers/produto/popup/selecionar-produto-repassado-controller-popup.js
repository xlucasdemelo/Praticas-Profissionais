 ...
 */
angular.module('home')
	   .controller('SelecionarProdutoRepassadoControllerPopup', function( $rootScope, $scope, $state, $importService, $mdDialog, $mdToast, $translate ) {
   ...
   /**
    ...
    {
    	$scope.model.produtoRepassado.entity = new ProdutoRepassado();
    	$scope.model.produtoRepassado.entity.produto = entity;
    	$scope.model.produtoRepassado.entity.repasse = $scope.$parent.model.repasse.entity;
    };
    ...
    $scope.associateSelectedEntity = function( ) {
    	...
    	$scope.model.produtoRepassado.form.$submitted = true;
		if ($scope.model.produtoRepassado.form.$invalid ){
			$scope.showMessage( $scope.ERROR_MESSAGE,  "Preencha os campos obrigatórios" );
			return;
		}
    	
    	var produtoRepassado = $scope.$parent.insertProdutoRepassado($scope.model.produtoRepassado.entity);
    	
    	$mdDialog.hide( produtoRepassado );
    };
