 ...
 */
angular.module('home')
	   .controller('SelecionarProdutoControllerPopup', function( $rootScope, $scope, $state, $importService, $mdDialog, $mdToast, $translate ) {
   ...
   /**
    ...
    {
    	$scope.model.produtoAdquirido.entity = new ProdutoAdquirido();
    	$scope.model.produtoAdquirido.entity.produto = entity;
    	$scope.model.produtoAdquirido.entity.aquisicaoProduto = $scope.$parent.model.aquisicaoProduto.entity;
    };
    ...
    $scope.associateSelectedEntity = function( ) {
    	...
    	var produtoAdquirido = $scope.$parent.insertProdutoAdquirido($scope.model.produtoAdquirido.entity);
    	
    	$mdDialog.hide( produtoAdquirido );
    };
