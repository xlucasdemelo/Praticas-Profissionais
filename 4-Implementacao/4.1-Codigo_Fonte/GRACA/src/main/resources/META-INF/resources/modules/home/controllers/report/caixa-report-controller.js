 ...
 */
angular.module('home')
	   .controller('CaixaReportController', function( $scope, $state, $importService, $mdToast, $mdDialog ) {
		 ...
		 */
		$scope.CAIXA_MOVIMENTACAO_CONTA_STATE = "relatorio-caixa.movimentacao-conta";
